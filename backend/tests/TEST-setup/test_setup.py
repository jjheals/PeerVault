...
def setup_user_keys(user_passphrase:str, user_enc_config_path:str, user_label:str) -> None: 
    ...
    generate_asymm_keys(
        ...
        user_enc_config['paths']['priv_key_path'],
        user_enc_config['paths']['pub_key_path'],
        user_passphrase
    )
    ...
    gen_aes_key(
        user_passphrase,
        user_enc_config['paths']['symm_key_path']
    )
...
# Call helper for sender
setup_user_db(
    sender_flask_config['paths']['DB_PATH'],
...
# Call helper for listener
setup_user_db(
    listener_flask_config['paths']['DB_PATH'],
